...
class SwinjectIoCContainer: NSObject, IoCContainer {
    ...
    func resolve<T, A, B>(arguments arg1: A, _ arg2: B) -> T {
        return container.resolve(T.self, arguments: arg1, arg2)!
    }
    
    func resolve<T, A, B, C>(arguments arg1: A, _ arg2: B, _ arg3: C) -> T {
        return container.resolve(T.self, arguments: arg1, arg2, arg3)!
    }
    
    func resolve<T, A, B, C, D>(arguments arg1: A, _ arg2: B, _ arg3: C, _ arg4: D) -> T {
        return container.resolve(T.self, arguments: arg1, arg2, arg3, arg4)!
    }
    
    func resolve<T, A, B, C, D, E>(arguments arg1: A, _ arg2: B, _ arg3: C, _ arg4: D, _ arg5: E) -> T {
        return container.resolve(T.self, arguments: arg1, arg2, arg3, arg4, arg5)!
    }
}
*/
